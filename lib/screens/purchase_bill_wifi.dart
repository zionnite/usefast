...
class PurchaseBillWifi extends StatefulWidget {
  const PurchaseBillWifi({Key? key, required this.utilityType}) : super(key: key);
  final String utilityType;

  @override
  State<PurchaseBillWifi> createState() => _PurchaseBillWifiState();
}

class _PurchaseBillWifiState extends State<PurchaseBillWifi> {
